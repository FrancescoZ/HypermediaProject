        ...
        <div class="col-md-8">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <p>${getServicesPanel(eglocations[i].id)}</p>
            </div>
          </div> 
          <button type="button" class="btn btn-info pull-right" onClick="clickLocation(${eglocations[i].id})">View details &raquo;</button>
        </div>
      </div>`)
  }
}
