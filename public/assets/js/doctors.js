...
function initDoctors(item, index) {
  $('#doctorsPanelLeft').append(
    `<div class="col-xs-12 col-sm-6 col-lg-4 doctor-featurette">
        <div class="well featurette">
          <h3>${item.name}</h3>
          <img class="center-img img-circle elevate center-block" width="150px" height="150px" style="object-fit: cover;" alt="location img" src="../assets/img/doctors/${item.image}">
